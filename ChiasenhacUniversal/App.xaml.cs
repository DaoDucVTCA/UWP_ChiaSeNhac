...
namespace ChiasenhacUniversal
{
    ...
    {
        public static ApplicationDataContainer themeColor = ApplicationData.Current.LocalSettings;
        public static ApplicationDataContainer bitrate = ApplicationData.Current.LocalSettings;
        ...
        public App()
        {
            ...
            int br = Convert.ToInt32(bitrate.Values["bitrate"]);
